        ...
        <ul className='filterBar' ref={ref}>
          <div>
            <FormControl>
              ...
              >
                {options &&
                  options.kindOfExpert.map((koe) => (
                    <MenuItem key={koe.id} value={koe.id}>
                      {' '}
                      {koe.value}{' '}
                    </MenuItem>
                  ))}
          ...
          <div>
            <FormControl>
              ...
              >
                {options &&
                  options.industry.map((indu) => (
                    <MenuItem key={indu.id} value={indu.id}>
                      {' '}
                      {indu.value}{' '}
                    </MenuItem>
                  ))}
          ...
          <div>
            <FormControl>
              ...
              >
                {options &&
                  options.expertiseLevel.map((yoe) => (
                    <MenuItem key={yoe.id} value={yoe.id}>
                      {' '}
                      {yoe.value}{' '}
                    </MenuItem>
                  ))}
